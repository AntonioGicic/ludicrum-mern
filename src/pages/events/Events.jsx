...
const Events = () => {
    ...
    async function fetchData() {
        try {
            setLoading(true);
            axios.get('https://ludicrum-mern-backend.onrender.com/dogadaji').then((response) => {
                if (isSortedByDate) {
    ...
    async function fetchDataQuery(e) {
        ...
        try {
            ...
            const queryUrl = 'https://ludicrum-mern-backend.onrender.com/dogadaji?city=' + cityQuery + '&date=' + dateQuery + '&category=' + categoryQuery;
